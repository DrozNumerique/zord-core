				<div id="<?php echo $models['id']; ?>" class="slide" data-index="<?php echo $models['index'] ?? '0'; ?>" data-frames="<?php echo $models['selector'] ?? 'li.frame'; ?>" data-direction="<?php echo $models['direction'] ?? 'vertical'; ?>" data-transition="<?php echo $models['transition'] ?? 'swipe'; ?>" data-interval="<?php echo $models['interval'] ?? '0'; ?>">
