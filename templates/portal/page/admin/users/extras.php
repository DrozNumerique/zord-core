...
<?php $this->render('/portal/widget/list', Zord::listModels('roles', $data['roles'], $choices)); ?>
            		<div class="admin-panel-title"><?php echo $locale->tab->users->ipv4; ?></div>
<?php $this->render('/portal/widget/list', Zord::listModels('ipv4', $data['ipv4'], $choices)); ?>
            		<div class="admin-panel-title"><?php echo $locale->tab->users->ipv6; ?></div>
<?php $this->render('/portal/widget/list', Zord::listModels('ipv6', $data['ipv6'], $choices)); ?>
     				<br/>
     				<br/>
